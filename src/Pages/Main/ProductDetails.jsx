...
function ProductDetails() {
  ...
  const Images = [
    {
      image: "https://www.cnet.com/a/img/resize/772dc049770725d83d7877219dddb799009d1325/hub/2023/09/14/78135723-a429-4236-98ff-77b798671a41/gettyimages-114338035-1.jpg?auto=webp&fit=crop&height=675&width=1200",
      code:1,
    },
    {
      ...
      <section className="product-details-page">
        ...
        <aside className="info-container">
          <section className="block-image">
            <main>
              <Zoom
                img={"https://www.cnet.com/a/img/resize/772dc049770725d83d7877219dddb799009d1325/hub/2023/09/14/78135723-a429-4236-98ff-77b798671a41/gettyimages-114338035-1.jpg?auto=webp&fit=crop&height=675&width=1200"}
                zoomScale={3}
                width={500}
                height={400}
              />
          ...
          <section className="block-info">
            <aside className='dets'>
              ...
              <h1 className="product-title">Painel  solar  / Kit de manutenção</h1>
